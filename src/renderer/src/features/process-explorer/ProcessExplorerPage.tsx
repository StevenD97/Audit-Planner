...
import { ClauseChip, EmptyState } from '../../components/common'
...
function ClausePicker({ onPick }: { onPick: (clauseId: string) => void }): JSX.Element {
...
function ClauseLinkList({ clauseIds, onRemove }: { clauseIds: string[]; onRemove: (clauseId: string) => void }): JSX.Element {
  return (
